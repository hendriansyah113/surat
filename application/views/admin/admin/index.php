				...
				<div class="container-fluid">
					...
					<div class="card">
						<div class="card-header">
							<a href="<?= site_url('admin/tambah') ?>" class="btn btn-sm btn-info">
								...
								<tbody>
									...
									<?php foreach ($data_users as $users) : ?>
										<tr>
											...
											<td>
												<a href="<?php echo site_url('admin/edit/' . $users->id) ?>"
													class="btn btn-sm btn-warning" title="Edit">
													<i class="fa fa-edit"></i>
												</a>
												<a href="#hapusModal-<?php echo $users->id; ?>"
													class="btn btn-sm btn-danger" data-toggle="modal"
													data-target="#hapusModal-<?php echo $users->id; ?>" title="Hapus">
													<i class="fa fa-trash"></i>
												</a>
											</td>
										</tr>
										<!-- Modal -->
										<div class="modal fade" id="hapusModal-<?php echo $users->id; ?>" tabindex="-1"
											...
											<div class="modal-dialog" role="document">
												<div class="modal-content">
													...
													<div class="modal-footer p-3">
														...
														<a href="<?= site_url('admin/hapus/' . $users->id) ?>"
