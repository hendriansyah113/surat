...
<head>
	...
	<script src="httbps://cdn.datatables.net/1.13.2/js/jquery.dataTables.min.js"></script>
				...
				<div class="container-fluid">
					...
					<div class="card">
						<div class="card-header">
							<a href="<?= site_url('akta_kelahiran/tambah') ?>" class="btn btn-sm btn-info">
						...
						<div class="card-body">
							<table id="table-data" class="table table-striped table-bordered dt-responsive nowrap"
								...
								<tbody>
									...
									$no = 1;
									?>
									<?php foreach ($data_akta_kelahiran as $ak) : ?>
										<tr>
											<td><?php echo $no++; ?></td>
											<td><?php echo $ak->nama; ?></td>
											<td><?php echo $ak->no_akta; ?></td>
											<td>
												<img src="<?= base_url('uploads/akta/' . $ak->file_akta); ?>"
													alt="Foto Kartu Keluarga" width="100">
											</td>
											<td>
												<a href="<?php echo site_url('akta_kelahiran/edit/' . $ak->id_akta) ?>"
													class="btn btn-sm btn-warning" title="Edit">
													<i class="fa fa-edit"></i>
												</a>
												<a href="#hapusModal-<?php echo $ak->id_akta; ?>"
													class="btn btn-sm btn-danger" data-toggle="modal"
													data-target="#hapusModal-<?php echo $ak->id_akta; ?>" title="Hapus">
													<i class="fa fa-trash"></i>
												</a>
											</td>
										</tr>
										<!-- Modal -->
										<div class="modal fade" id="hapusModal-<?php echo $ak->id_akta; ?>" tabindex="-1"
											...
											<div class="modal-dialog" role="document">
												<div class="modal-content">
													...
													<div class="modal-footer p-3">
														...
														<a href="<?= site_url('akta_kelahiran/hapus/' . $ak->id_akta) ?>"
