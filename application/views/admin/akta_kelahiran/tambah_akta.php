			...
			<main class="content">
				<div class="container-fluid">
					...
					<div class="card">
						...
						<form action="<?= site_url('akta_kelahiran/tambah') ?>" method="post"
							...
							<div class="card-body">
								<div class="row">
									...
									<div class="col-md-12">
										<div class="form-group mb-3">
											...
											<input type="number" name="no_akta"
												...
												value="<?php echo set_value('no_akta'); ?>"
												placeholder="No. Akta Kelahiran" autocomplete="off">
											<div class="invalid-feedback">
									...
									<div class="col-md-12">
										<div class="form-group mb-3">
											<label for="file_akta"
												class="form-label <?php echo form_error('file_akta') ? 'text-danger' : ''; ?>">File
												Akta Kelahiran</label>
											<input type="file" name="file_akta"
												class="form-control <?php echo form_error('file_akta') ? 'is-invalid' : ''; ?>"
												required>
											<div class="invalid-feedback">
