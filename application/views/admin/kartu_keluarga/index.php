				...
				<div class="container-fluid">
					...
					<div class="card">
						<div class="card-header">
							<a href="<?= site_url('kartu_keluarga/tambah') ?>" class="btn btn-sm btn-info">
						...
						<div class="card-body">
							<table id="table-data" class="table table-striped table-bordered dt-responsive nowrap"
								...
								<tbody>
									...
									$no = 1;
									?>
									<?php foreach ($data_kartu_keluarga as $kk) : ?>
										<tr>
											<td><?php echo $no++; ?></td>
											...
											<td>
												<a href="<?php echo site_url('kartu_keluarga/edit/' . $kk->id_kk) ?>"
													class="btn btn-sm btn-warning" title="Edit">
													<i class="fa fa-edit"></i>
												</a>
												<a href="#hapusModal-<?php echo $kk->id_kk; ?>"
													class="btn btn-sm btn-danger" data-toggle="modal"
													data-target="#hapusModal-<?php echo $kk->id_kk; ?>" title="Hapus">
													<i class="fa fa-trash"></i>
												</a>
											</td>
										</tr>
										<!-- Modal -->
										<div class="modal fade" id="hapusModal-<?php echo $kk->id_kk; ?>" tabindex="-1"
											...
											<div class="modal-dialog" role="document">
												<div class="modal-content">
													...
													<div class="modal-footer p-3">
														...
														<a href="<?= site_url('kartu_keluarga/hapus/' . $kk->id_kk) ?>"
