				...
				<div class="container-fluid">
					...
					<div class="card">
						<div class="card-header">
							<a href="<?= site_url('penduduk/tambah') ?>" class="btn btn-sm btn-info">
								...
								<tbody>
									...
									<?php foreach ($data_penduduk as $penduduk) : ?>
										<tr>
											...
											<td><?php echo $penduduk->unit; ?></td>
											<td><?php echo $penduduk->tempat_lahir . ", " . $penduduk->tanggal_lahir; ?>
											</td>
											<td><?php echo $penduduk->jenis_kelamin; ?></td>
											<td>
												<a href="<?php echo site_url('penduduk/edit/' . $penduduk->id_penduduk) ?>"
													class="btn btn-sm btn-warning" title="Edit">
													<i class="fa fa-edit"></i>
												</a>
												<a href="#hapusModal-<?php echo $penduduk->id_penduduk; ?>"
													class="btn btn-sm btn-danger" data-toggle="modal"
													data-target="#hapusModal-<?php echo $penduduk->id_penduduk; ?>"
													title="Hapus">
													<i class="fa fa-trash"></i>
												</a>
											</td>
											<td><?php echo $penduduk->status_nikah; ?></td>
										</tr>
										<!-- Modal -->
										<div class="modal fade" id="hapusModal-<?php echo $penduduk->id_penduduk; ?>"
											...
											<div class="modal-dialog" role="document">
												<div class="modal-content">
													...
													<div class="modal-footer p-3">
														...
														<a href="<?= site_url('penduduk/hapus/' . $penduduk->id_penduduk) ?>"
