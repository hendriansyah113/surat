			...
			<main class="content">
				<div class="container-fluid">
					...
					<div class="card">
						...
						<form action="<?= site_url('penduduk/tambah') ?>" method="post" enctype="multipart/form-data">
							<div class="card-body">
								<div class="row">
									<div class="col-md-12">
										<div class="form-group mb-3">
											...
											<input type="text" name="nama"
												...
												value="<?php echo set_value('nama'); ?>" placeholder="Nama Penduduk"
												autocomplete="off">
									...
									<div class="col-md-12">
										<div class="form-group mb-3">
											...
											<input type="number" name="nik"
												...
												value="<?php echo set_value('nik'); ?>" placeholder="NIK Penduduk"
												autocomplete="off">
											<div class="invalid-feedback">
									...
									<div class="col-md-12">
										<div class="form-group mb-3">
											...
											<textarea name="alamat"
												...
												rows="3"><?php echo set_value('alamat'); ?></textarea>
											<div class="invalid-feedback">
									...
									<div class="col-md-12">
										<div class="form-group mb-3">
											...
											<input type="text" name="pekerjaan"
												...
												value="<?php echo set_value('pekerjaan'); ?>" placeholder="Pekerjaan"
												autocomplete="off">
											<div class="invalid-feedback">
										...
										<div class="form-group mb-3">
											...
											<div class="form-check">
												<input type="radio" id="laki_laki" name="jenis_kelamin"
													...
													<?php echo set_radio('jenis_kelamin', 'Laki_laki'); ?>>
										...
										<div class="form-group mb-0">
											...
											<div class="form-check">
												<input type="radio" id="belum_menikah" name="status_nikah"
													...
													<?php echo set_radio('status_nikah', 'Belum Menikah'); ?>>
