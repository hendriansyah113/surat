										...
										<tr>
											...
											<td>
												<?php if ($permohonan->status == 'Menunggu') : ?>
													<a href="<?= site_url('sk_domisili/acc_permohonan/' . $permohonan->id) ?>"
														class="btn btn-success">ACC</a>
													<a href="<?= site_url('sk_domisili/tolak_permohonan/' . $permohonan->id) ?>"
														class="btn btn-danger">Tolak</a>
												<?php elseif ($permohonan->status == 'Disetujui') : ?>
													<a href="<?= site_url('sk_domisili/cetak_surat/' . $permohonan->id) ?>"
														class="btn btn-info" target="_blank">Lihat Surat</a>
													<a href="<?= site_url('sk_domisili/cancel_permohonan/' . $permohonan->id) ?>"
											...
											<td><a href="<?= site_url('sk_domisili/hapus_admin/' . $permohonan->id) ?>"
