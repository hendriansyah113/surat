...
<body>
	<div class="container">
		...
		<p class="title"><strong>SURAT NIKAH</strong></p>
		...
		<div class="content">
			...
			<p>Dengan ini menyatakan bahwa yang bersangkutan benar-benar adalah warga Kecamatan
				Jekan Raya, Kota Palangka Raya, dan sesuai dengan data yang ada pada kami yaitu
				<strong><?= $permohonan['status_nikah'] ?></strong>.
			</p>
			<p>Demikian surat keterangan nikah ini dibuat untuk dapat dipergunakan sebagaimana mestinya.</p>
			<br>
			<br>
			<br>
		</div>
