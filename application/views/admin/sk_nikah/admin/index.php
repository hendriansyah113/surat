										...
										<tr>
											...
											<td>
												<?php if ($permohonan->status == 'Menunggu') : ?>
													<a href="<?= site_url('sk_nikah/acc_permohonan/' . $permohonan->id) ?>"
														class="btn btn-success">ACC</a>
													<a href="<?= site_url('sk_nikah/tolak_permohonan/' . $permohonan->id) ?>"
														class="btn btn-danger">Tolak</a>
												<?php elseif ($permohonan->status == 'Disetujui') : ?>
													<a href="<?= site_url('sk_nikah/cetak_surat/' . $permohonan->id) ?>"
														class="btn btn-info" target="_blank">Lihat Surat</a>
													<a href="<?= site_url('sk_nikah/cancel_permohonan/' . $permohonan->id) ?>"
											...
											<td><a href="<?= site_url('sk_nikah/hapus_admin/' . $permohonan->id) ?>"
