...
<body>
	<div class="container">
		...
		<p class="title"><strong>SURAT PENGHASILAN</strong></p>
		...
		<div class="content">
			...
			<p>Berdasarkan data yang ada di Kecamatan Jekan Raya, yang bersangkutan memiliki penghasilan sebesar:
			</p>
			<table>
				<tr>
					<td>Penghasilan Tetap</td>
					<td>: <?= "Rp " . number_format($permohonan['penghasilan_tetap'], 0, ',', '.') ?></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>:
						<?php
						$penghasilan_total = $permohonan['penghasilan_tetap'] + $permohonan['penghasilan_tambahan'];
						echo "Rp " . number_format($penghasilan_total, 0, ',', '.');
						?>
					</td>
				</tr>
			</table>
