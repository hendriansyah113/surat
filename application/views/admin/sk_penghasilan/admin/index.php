								...
								<tbody>
									<?php foreach ($permohonan_list as $index => $permohonan) : ?>
										<tr>
											...
											<td><?= "Rp " . number_format($permohonan->penghasilan_tetap, 0, ',', '.') ?>
											</td>
											<td><?= "Rp " . number_format($permohonan->penghasilan_tambahan, 0, ',', '.') ?>
											</td>
											<td><?= $permohonan->tanggal_permohonan ?></td>
											<td><?= $permohonan->status ?></td>
											<td>
												<?php if ($permohonan->status == 'Menunggu') : ?>
													<a href="<?= site_url('sk_penghasilan/acc_permohonan/' . $permohonan->id) ?>"
														class="btn btn-success">ACC</a>
													<a href="<?= site_url('sk_penghasilan/tolak_permohonan/' . $permohonan->id) ?>"
														class="btn btn-danger">Tolak</a>
												<?php elseif ($permohonan->status == 'Disetujui') : ?>
													<a href="<?= site_url('sk_penghasilan/cetak_surat/' . $permohonan->id) ?>"
														class="btn btn-info" target="_blank">Lihat Surat</a>
													<a href="<?= site_url('sk_penghasilan/cancel_permohonan/' . $permohonan->id) ?>"
											...
											<td><a href="<?= site_url('sk_penghasilan/hapus_admin/' . $permohonan->id) ?>"
