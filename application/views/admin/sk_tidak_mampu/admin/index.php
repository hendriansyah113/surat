										...
										<tr>
											...
											<td>
												<?php if ($permohonan->status == 'Menunggu') : ?>
													<a href="<?= site_url('sk_tidak_mampu/acc_permohonan/' . $permohonan->id) ?>"
														class="btn btn-success">ACC</a>
													<a href="<?= site_url('sk_tidak_mampu/tolak_permohonan/' . $permohonan->id) ?>"
														class="btn btn-danger">Tolak</a>
												<?php elseif ($permohonan->status == 'Disetujui') : ?>
													<a href="<?= site_url('sk_tidak_mampu/cetak_surat/' . $permohonan->id) ?>"
														class="btn btn-info" target="_blank">Lihat Surat</a>
													<a href="<?= site_url('sk_tidak_mampu/cancel_permohonan/' . $permohonan->id) ?>"
											...
											<td><a href="<?= site_url('sk_tidak_mampu/hapus_admin/' . $permohonan->id) ?>"
