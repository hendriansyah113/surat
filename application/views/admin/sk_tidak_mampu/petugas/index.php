				...
				<div class="container-fluid">
					...
					<div class="card">
						<div class="card-header">
							<a href="<?= site_url('sk_tidak_mampu/tambah') ?>" class="btn btn-sm btn-info">
										...
										<tr>
											...
											<td>
												<?php if ($permohonan->status === 'Menunggu') : ?>
													<a href="<?= site_url('sk_tidak_mampu/edit/' . $permohonan->id) ?>"
														class="btn btn-warning btn-sm">Edit</a>
													<a href="<?= site_url('sk_tidak_mampu/hapus/' . $permohonan->id) ?>"
