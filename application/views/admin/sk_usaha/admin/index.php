								...
								<tbody>
									<?php foreach ($permohonan_list as $index => $permohonan) : ?>
										<tr>
											...
											<td><?= $permohonan->tahun_usaha ?></td>
											<td><?= $permohonan->tanggal_permohonan ?></td>
											<td><?= $permohonan->status ?></td>
											<td>
												<?php if ($permohonan->status == 'Menunggu') : ?>
													<a href="<?= site_url('sk_usaha/acc_permohonan/' . $permohonan->id) ?>"
														class="btn btn-success">ACC</a>
													<a href="<?= site_url('sk_usaha/tolak_permohonan/' . $permohonan->id) ?>"
														class="btn btn-danger">Tolak</a>
												<?php elseif ($permohonan->status == 'Disetujui') : ?>
													<a href="<?= site_url('sk_usaha/cetak_surat/' . $permohonan->id) ?>"
														class="btn btn-info" target="_blank">Lihat Surat</a>
													<a href="<?= site_url('sk_usaha/cancel_permohonan/' . $permohonan->id) ?>"
											...
											<td><a href="<?= site_url('sk_usaha/hapus_admin/' . $permohonan->id) ?>"
