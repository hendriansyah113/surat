        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="<?= site_url('sk_usaha/edit/' . $permohonan['id']) ?>" method="post">
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="id_penduduk"
                                            ...
                                            <option value="<?= $penduduk->id_penduduk ?>"
                                                <?= $penduduk->id_penduduk == $permohonan['id_penduduk'] ? 'selected' : '' ?>>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="nomor"
                                            ...
                                            value="<?= $permohonan['nomor'] ?>" placeholder="Nomor Surat"
                                            autocomplete="off">
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        <label for="nama_usaha"
                                            class="form-label <?php echo form_error('nama_usaha') ? 'text-danger' : ''; ?>">Nama
                                            Usaha
                                            Surat
                                        </label>
                                        <input type="text" name="nama_usaha"
                                            class="form-control <?php echo form_error('nama_usaha') ? 'is-invalid' : ''; ?>"
                                            value="<?= $permohonan['nama_usaha'] ?>" placeholder="Nama Usaha"
                                            autocomplete="off">
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        <label for="tahun_usaha"
                                            class="form-label <?php echo form_error('tahun_usaha') ? 'text-danger' : ''; ?>">Tahun
                                            Usaha
                                            Surat
                                        </label>
                                        <input type="text" name="tahun_usaha"
                                            class="form-control <?php echo form_error('tahun_usaha') ? 'is-invalid' : ''; ?>"
                                            value="<?= $permohonan['tahun_usaha'] ?>" placeholder="Tahun Usaha"
                                            autocomplete="off">
                                        <div class="invalid-feedback">
                                            <?php echo form_error('tahun_usaha'); ?>
                                        </div>
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-primary">Edit</button>
                                <a href="<?= site_url('sk_usaha') ?>" class="btn btn-secondary">Batal</a>
                            </form>
                        </div>
                    </div>
                </div>
