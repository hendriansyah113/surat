		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid">
					...
					<div class="card">
						<div class="card-body">
							<form action="<?= site_url('sk_usaha/tambah') ?>" method="post">
								<div class="col-md-12">
								...
								<div class="col-md-12">
									<div class="form-group mb-3">
										...
										<input type="text" name="nama_usaha"
											...
											value="<?php echo set_value('nama_usaha'); ?>" placeholder="Nama Usaha"
											autocomplete="off">
										<div class="invalid-feedback">
								...
								<div class="col-md-12">
									<div class="form-group mb-3">
										...
										<input type="number" name="tahun_usaha"
											class="form-control <?php echo form_error('tahun_usaha') ? 'is-invalid' : ''; ?>"
											value="<?php echo set_value('tahun_usaha'); ?>" placeholder="Tahun Usaha"
											autocomplete="off">
										<div class="invalid-feedback">
