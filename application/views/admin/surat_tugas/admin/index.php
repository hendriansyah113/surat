										...
										<tr>
											...
											<td>
												<?php if ($permohonan->status == 'Menunggu') : ?>
													<a href="<?= site_url('surat_tugas/acc_permohonan/' . $permohonan->id) ?>"
														class="btn btn-success">ACC</a>
													<a href="<?= site_url('surat_tugas/tolak_permohonan/' . $permohonan->id) ?>"
														class="btn btn-danger">Tolak</a>
												<?php elseif ($permohonan->status == 'Disetujui') : ?>
													<a href="<?= site_url('surat_tugas/cetak_surat/' . $permohonan->id) ?>"
														class="btn btn-info" target="_blank">Lihat Surat</a>
													<a href="<?= site_url('surat_tugas/cancel_permohonan/' . $permohonan->id) ?>"
											...
											<td><a href="<?= site_url('surat_tugas/hapus_admin/' . $permohonan->id) ?>"
