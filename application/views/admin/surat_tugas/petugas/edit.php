		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid">
					...
					<div class="card">
						<div class="card-body">
							<form action="<?= site_url('surat_tugas/edit/' . $permohonan['id']) ?>" method="post">
								<div class="col-md-12">
								...
								<div class="col-md-12">
									<div class="form-group mb-3">
										...
										<textarea name="keterangan" id="keterangan" class="form-control"
											required><?= $permohonan['keterangan'] ?></textarea>
									</div>
								</div>
								<button type="submit" class="btn btn-primary">Edit</button>
								<a href="<?= site_url('surat_tugas') ?>" class="btn btn-secondary">Batal</a>
							</form>
						</div>
					</div>
				</div>
